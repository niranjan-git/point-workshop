...
class ZoneStateMapModelAdmin(admin.ModelAdmin):
...
class EnrolledParticipantModelAdmin(admin.ModelAdmin):
...
class UserAssignedRoleModelAdmin(admin.ModelAdmin):
    list_display = ('user', 'role', 'zone', 'branch', 'user_status')
